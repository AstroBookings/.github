...
-- Launches
INSERT INTO launches (id, agency_id, rocket_id, date, destination, price_per_seat, status)
VALUES 
  ('lnch_1', 'usr_a1', 'rkt_1', '2025-07-20 10:00:00', 'Moon', 28000000, 'scheduled'),
  ('lnch_2', 'usr_a2', 'rkt_2', '2025-09-15 14:30:00', 'Low Earth Orbit', 250000, 'confirmed'),
  ('lnch_3', 'usr_a1', 'rkt_3', '2026-01-01 00:00:00', 'Mars', 55000000, 'scheduled');
...
-- Templates
INSERT INTO templates (id, event_name, subject, message) VALUES ('tmpl_1', 'booking_confirmed', 'Booking Confirmation', 'Your booking for {number_of_seats} seat(s) on the launch to {destination} on {date} has been confirmed.');
